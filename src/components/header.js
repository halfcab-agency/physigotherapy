              ...
              <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    <a href="#">
                      <span className="sr-only">Physi-Go-Therapy</span>
                      <StaticImage
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:px-8 lg:mt-20 xl:mt-36 lg:flex lg:items-center">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-800 sm:text-5xl md:text-6xl">
                <span className="font-display block xl:inline">Perth's best mobile and clinic-based</span>{' '}
                <span className="font-display block xl:inline">physiotherapy services.</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                We help people achieve their individual goals through high quality and evidence-based physiotherapy services. We look forward to working with you to reach your holistic goals! 
              </p>
